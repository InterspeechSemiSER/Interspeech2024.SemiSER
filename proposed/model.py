...
class ProposedModel(Wav2Vec2PreTrainedModel):
        ...
        # training mode
            ...
            if logits_w_groundtruth.shape[0] > 0:
                ...
                if logits_w_pseudo_label.shape[0] > 0:
                    ...
                    loss_s = LogitMargin()(logits_s_pseudo_label, preds_w)
                    
                    loss_npl = npl_loss(logits_w_pseudo_label, logits_s_pseudo_label, 1, self.config.num_labels)
                    loss_margin = LogitMargin()(logits_s_pseudo_label, preds_w)
                ...
                # if no pseudo label, use groundtruth preds to calculate loss
                    ...
                    loss_s = LogitMargin()(logits_s_groundtruth, preds_w)
                    loss_npl = 0.0
